...
<html>
    <head>
        ...
        <style>
            ...
            .banner-img {
                height: 500px; /* adjust the height value to your desired value */
                object-fit: cover;
                width: 100%;
            }
            .nav-links {
...
//                }
                    ...
                    <div id="banner">
                        <div class="carousel-inner">
                            <div class="carousel-item active" data-bs-interval="10000">
                                <img id="bannerimg" src="/ShoeSense/img/banner/abanner1.jpg" class="d-block w-100 banner-img" alt="banner1">
                                <div class="carousel-caption d-none d-md-block">
                                </div>
                            </div>
                            <div class="carousel-item" data-bs-interval="2000">
                                <img id="bannerimg" src="/ShoeSense/img/banner/abanner2.jpg" class="d-block w-100 banner-img" alt="banner2">
                                <div class="carousel-caption d-none d-md-block">
                                </div>
                            </div>
                            <div class="carousel-item">
                                <img id="bannerimg" src="/ShoeSense/img/banner/abanner3.jpg" class="d-block w-100 banner-img" alt="banner3">
                                <div class="carousel-caption d-none d-md-block">
                                </div>
                            </div>
                        </div>
        ...
        <div class="nav-links">
            <a href="?search=${param['search']}&sort=${param['sort']}&category='Shoe'">Shoe</a>
            <a href="?search=${param['search']}&sort=${param['sort']}&category='Sandal'">Sandal</a>
            <a href="?search=${param['search']}&sort=${param['sort']}&category='Boot'">Boot</a>
            <a href="?search=${param['search']}&sort=${param['sort']}&category='Heel'">Heel</a>
        </div>
        <hr>
        <div id="sort" class="row" style="margin-left: 60px">
            <div class="col-3">
                <div class="form-floating row">
                    <div class="col-6">
                        <div class="form-floating row">
                            <select class="form-select form-select-sm" id="floatingSelectGrid" name="sort" onchange="this.form.submit()" style="padding-left: 12px">
        ...
        <div class="row">
            <c:forEach var="o" items="${plist}">
                <c:if test="${o.productStatus == 'Public'}">
                    <div class="col-sm-12 col-md-4 col-lg-2 mb-5">
                       <a href="/ShoeSense/product/detail/${o.productID}" class="text-decoration-none" >
                            <div class="card h-100">
                                <img src="/ShoeSense/${o.productImg}" class="card-img-top" alt="${o.productName}">
                                <div class="card-body">
                                    <h5 class="card-title" style="font-weight: bold; text-transform: uppercase;" >${o.productName} </h5>
                                    <p class="card-text">
                                        <fmt:formatNumber pattern="###,###" value="${o.productPrice}"/>  VNÐ
                                    </p>
                                    ...
                                    %>
                                    <p class="card-text">Stock: <%= totalVariantQuantity > 0 ? totalVariantQuantity : "Out Of Stock" %></p>
                                </div>
                            </div>
                        </a>
                    </div>
