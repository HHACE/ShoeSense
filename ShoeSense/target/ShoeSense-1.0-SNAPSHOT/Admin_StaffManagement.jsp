                            ...
                            <c:forEach items="${listStaff}" var="o">
                                ...
                                <tr>
                                    ...
                                    <td class="align-middle">
                                        <a href="/ShoeSense/admin/staff/manage/edit/${o.accountID}" class="btn btn-primary text-white m-2" ><i class="fa fa-pencil p-1"></i></a>
                                        ...
                                        %>
                                        <a href="/ShoeSense/admin/staff/manage/status/ban/${o.accountID}" onclick="return confirm('Bạn có chắc chắn muốn xóa nhân viên này không?')" class="btn btn-danger text-white m-2" name="delete" >Ban</a>
                                        <%
                                        } else {
                                        %>
                                        <a href="/ShoeSense/admin/staff/manage/status/unban/${o.accountID}" onclick="return confirm('Bạn có chắc chắn muốn xóa nhân viên này không?')" class="btn btn-danger text-white m-2" name="delete" >Unbanned</a>
                                        <%
                                            }
                                        %>
                                    </td>
