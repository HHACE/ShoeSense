                        ...
                        <table id="example"  style="width: 1300px" >
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <form method="post" action="/ShoeSense/comment/manage/product/<%= com.getCommentID()%>">
                                        <input value="<%= com.getCommentID()%>" name="commentID" id="commentID"  type="hidden">
                                        <%
                                            if (com.getCommentStatus().equalsIgnoreCase("Public")) {
                                        %>
                                        <button type="submit" name="btnHide" id="btnHide" class="btn btn-danger m-2">Public</button>
                                        <%
                                        } else {
                                        %>
                                        <button type="submit" name="btnPublic" id="btnPublic" class="btn btn-danger m-2">Hide</button>
                                        <%
                                            }
                                        %>
