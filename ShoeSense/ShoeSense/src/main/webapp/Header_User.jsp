            ...
            <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <!--Search-->
                        <form class="d-flex container" role="search" aria-label="Search" action="/ShoeSense/?sort=${param['sort']}&search=${param['search']}">
                        ...
                        <ul class="navbar-nav d-sm-flex flex-sm-row justify-content-sm-center row me-5">
                            ...
                            <!--Login-->
                            <li class="nav-item">
                                <button onclick="window.location.href = '/ShoeSense/login'" id="LoginButton" type="button" class="btn btn-secondary fw-bold rounded-5"style="color: white; margin-right:20px " href="#"
