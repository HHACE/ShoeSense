<%-- 
    Document   : Admin_Finance
    Created on : Jul 6, 2024, 8:51:27 AM
    Author     : ADMIN
--%>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="align-middle">
                                    <a class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#StatusLog<%= i.getOrderID()%>">Status Log</a>
                                    <a class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#OrderDetail<%= i.getOrderID()%>">Product Details</a>
                                    <!-- Product Details Modal -->
                                    <div style="font-size: 1.25rem"class="modal fade" id="OrderDetail<%= i.getOrderID()%>">" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                                    ...
                                    <!-- Status Log Modal -->
                                    <div  style="font-size: 1.25rem"class="modal fade" id="StatusLog<%= i.getOrderID()%>">" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                                        <div class="modal-dialog modal-dialog-scrollable modal-xl">
                                            <div class="modal-content">
                                                <div class="modal-header">
