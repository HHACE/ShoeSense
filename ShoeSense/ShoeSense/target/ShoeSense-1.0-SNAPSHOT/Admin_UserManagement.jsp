...
//               }
    ...
    <body class="allbody">
        ...
        <a style="width: auto"href="" class="navbar ps-5"> ShoeSense - ADMIN </a>
        <div class="main-body">
                        ...
                        <table id="example">
                            <thead>
                                <tr>
                                    ...
                                    <th style="width: 110px" class="align-middle">User Name</th>
                                    <th class="align-middle">Gender</th>
                                    <th class="align-middle">Email</th>
                                    <th  style="width: 150px"class="align-middle">Date of birth</th>
                                    <th class="align-middle">Phone number</th>
                                    <th class="align-middle">Address</th>
                                    <th class="align-middle">Status</th>
                                    <th style="width: 460px" class="align-middle"></th>
                                </tr>
                            </thead>
                            <tbody>
                            ...
                            <c:forEach items="${listUser}" var="o">
                                ...
                                <tr>
                                    ...
                                    <td class="align-middle">
                                        ...
                                        %>
                                        <a href="/ShoeSense/admin/user/manage/status/ban/${o.accountID}" onclick="return confirm('Are you sure about banning this user?')" class="btn btn-danger text-white m-2" name="delete" >Ban</a>
                                        <%
                                        } else {
                                        %>
                                        <a href="/ShoeSense/admin/user/manage/status/unban/${o.accountID}" onclick="return confirm('Are you sure about unbanning this user?')" class="btn btn-danger text-white m-2" name="delete" >Unbanned</a>
                                        <%
                                            }
                                        %>
                                    </td>
