                        ...
                        <tbody id="data">
                            <c:forEach items="${list}" var="c">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <fmt:formatNumber value="${c.getProductPrice()}" pattern="###,###,###" /> VNÐ
                                    </td>
                                    ...
                                    <td>
                                        <c:if test="${c.productStatus == 'Public'}">
                                            ...
                                            <a  href="manage?type=hide&pid=${c.productID}" class="btn btn-primary text-white m-2" >Public</a>
                                        </c:if>
                                        <c:if test="${c.productStatus == 'Hide'}">
                                            <a href="manage?type=public&pid=${c.productID}" class="btn btn-primary text-white m-2" >Hide</a>
                                        </c:if>

                                    </td>
                                    <td>
                                        <a href="manage?type=update&pid=${c.productID}" class="btn btn-primary text-white m-2" ><i class="fas fa-pen"></i></a>
                                        ...
                                        <button type="button" class="btn btn-primary m-2" onclick="window.location.href = '/ShoeSense/product/variant/${c.productID}'">Variant</button>
